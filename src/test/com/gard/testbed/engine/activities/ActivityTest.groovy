...
class ActivityTest extends GroovyTestCase {
    ...
    def activity = new Activity("Activity name", "Test instructions")
    ...
    void testGetName() {
        ...
        assertEquals("Wrong activity name", "Activity name", activity.getName())
    }
    ...
    void testGetTaskLevel0() {
        assertEquals("Activity task level should be 0", 0, activity.getTaskLevel())
    }

    void testGetTaskLevel1() {
        assertEquals("Activity task level should be 1", 1, activity.getTask("Task 2").getTaskLevel())
    }

    void testGetTaskLevel2() {
        assertEquals("Activity task level should be 2", 2, activity.getTask("Task 11").getTaskLevel())
    }

    void testGetTaskLevel3() {
        assertEquals("Activity task level should be 3", 3, activity.getTask("Task 422").getTaskLevel())
    }
